...
final LinearGradient selectedGradient = LinearGradient(
    colors: [HexColor.fromHex("#5092F0"), HexColor.fromHex("#636CE1")],
    begin: FractionalOffset.centerLeft,
    end: FractionalOffset.centerRight);
final LinearGradient unselectedGradient = LinearGradient(colors: [
  ColorsInfo.IsDark ? HexColor.fromHex("#8E8E8E") : HexColor.fromHex("#353539"),
  ColorsInfo.IsDark ? HexColor.fromHex("#8E8E8E") : HexColor.fromHex("#353539")
                            ...
                            child: InkWell(
                              ...
                              onTap: () => {
                                ...
                                if (ModService.sharedPreferences != null)
                                  {
                                    ModService.sharedPreferences!.setBool(
                                        "color_is_dark", ColorsInfo.IsDark)
                                  },
