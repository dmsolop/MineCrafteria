...
import 'package:minecrafteria/frontend/InstructionScreen.dart';
...
final blueGradient = LinearGradient(colors: [HexColor.fromHex("#5E53F1"), HexColor.fromHex("#5E53F1")], begin: FractionalOffset.centerLeft, end: FractionalOffset.centerRight);
...
class ModDetailScreenPadWidget extends StatefulWidget {
  ...
  const ModDetailScreenPadWidget({super.key, required this.modItem, required this.modListScreen, required this.favoritesListScreen, required this.modListIndex});

  @override
  ModDetailScreenPad createState() => ModDetailScreenPad(modItem: modItem, modListScreen: modListScreen, favoriteListScreen: favoritesListScreen, modList: modListIndex);
}
...
class ModDetailScreenPad extends State<ModDetailScreenPadWidget> {
  ...
  ModDetailScreenPad({required this.modItem, required this.modListScreen, required this.favoriteListScreen, required this.modList});
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                child: ShaderMask(
                  shaderCallback: (rect) {
                    return (modService!.isFavoriteMod(modItem) ? ColorsInfo.ColorToGradient(HexColor.fromHex("#f02424")) : (ColorsInfo.IsDark ? ColorsInfo.ColorToGradient(HexColor.fromHex("#25292E")) : ColorsInfo.ColorToGradient(HexColor.fromHex("#8e8e8e"))))
                  ...
                  if (true)
                    {
                      ...
                      Navigator.pushReplacement(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (context, animation, secondaryAnimation) => ModDetailScreenPadWidget(
                            modItem: modItem,
                              ...
                              child: Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: Text(
                                      modItem.title,
                                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Joystix_Bold", color: ColorsInfo.IsDark ? Colors.white : HexColor.fromHex("#353539")),
                                      maxLines: 10,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          modItem.fileSize,
                                          style: TextStyle(fontSize: 14, color: HexColor.fromHex("#8E8E8E")),
                                        ),
                                        const SizedBox(width: 12), // Space between icons
                                        Image.asset('assets/images/downloads_icon.png', width: 20, height: 20),
                                        const SizedBox(width: 6),
                                        Text(modItem.downloads.toString(), style: TextStyle(color: HexColor.fromHex("#8E8E8E"), fontSize: 14)),
                                      ],
                                    ),
                                  ),
                                ],
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  child: Container(
                                      height: 57,
                                      constraints: BoxConstraints(maxWidth: screenWidth / 2.77),
                                      decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(15)), gradient: cached ? ColorsInfo.ColorToGradient(HexColor.fromHex("#586067")) : (modItem.isPremium ? yellowGradient : (modItem.isRewarded ? purpleGradient : blueGradient))),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: const TextStyle(color: Colors.white, fontSize: 18, fontFamily: "Joystix_Bold"),
                                            ),
                                          ],
                                        ),
                                      )),
                                    ...
                                    if (modItem.isPremium)
                                      {
                                        ...
                                        if (paths.length == 1)
                                          {await FileOpener.openFileWithApp(paths[0], MediaQuery.of(context).size.width, MediaQuery.of(context).size.height, context)}
                                                          ...
                                                          Padding(
                                                              ...
                                                              child: SingleChildScrollView(
                                                                child: Container(
                                                                  color: ColorsInfo.GetColor(ColorType.Second),
                                                                  height: 50,
                                                                  constraints: const BoxConstraints(maxWidth: 540 - 50),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: InkWell(
                                                                          ...
                                                                          onTap: () async => {await FileOpener.openFileWithApp(path, MediaQuery.of(context).size.width, MediaQuery.of(context).size.height, context)},
                                                                        ),
                                                                      )
                                                                    ],
                                                                  ),
                                        ...
                                        if (paths.length == 1) Navigator.of(context, rootNavigator: true).pop(),
                                      }
                                    else
                                      {
                                ...
                                InkWell(
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        gradient: ColorsInfo.ColorToGradient(HexColor.fromHex("#586067")),
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: [
                                            cached
                                                ? Image.asset('assets/images/icon_delete.png', width: 40, height: 40)
                                                : Text(
                                                    "?",
                                                    style: TextStyle(color: HexColor.fromHex("#8D8D8D"), fontSize: 25),
                                                  ),
                                          ],
                                        ),
                                      )),
                                  onTap: () async => {
                                    if (cached)
                                      {
                                        await CacheManager.deleteCachedFiles(modItem.downloadURL),
                                        if (modListScreen != null)
                                          {
                                            modListScreen!.setState(() {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(fontSize: 18, color: ColorsInfo.IsDark ? Colors.white : HexColor.fromHex("#353539")),
                                  ),
                                ],
                              ),
                            ),
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(fontSize: 15, color: ColorsInfo.IsDark ? HexColor.fromHex("#8D8D8D") : HexColor.fromHex("#353539")),
                    ...
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            for (int i = 0; i < (MediaQuery.of(context).size.width / (150 * 1.4)); i++) getMiniMod(modService!.mods[modList][random.nextInt(modService!.mods[modList].length)], modListScreen, favoriteListScreen, context),
                            const SizedBox(
                              width: 5,
                            ),
                          ],
