...
class ModItemMini extends StatefulWidget {
  ...
  const ModItemMini({super.key, required this.modItemData});
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(widget.modItemData.imageUrl,
                    ...
                    width: 1000,
                    height: MediaQuery.of(context).size.width > 700 ? 140 : 150,
                    fit: BoxFit.cover,
                  ...
                  child: Align(
                    ...
                    child: Image.asset(
                      widget.modItemData.isPremium
                          ? 'assets/images/mod_cardmini_overlay_premium.png'
                          : 'assets/images/mod_cardmini_overlay_ads.png',
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          color:
                              ColorsInfo.IsDark ? Colors.white : Colors.black),
                      maxLines: 1,
                    ),
                  ),
                ],
