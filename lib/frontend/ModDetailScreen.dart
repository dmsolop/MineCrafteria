...
final blueGradient = LinearGradient(
    colors: [HexColor.fromHex("#E5A272"), HexColor.fromHex("#E5A272")],
...
class ModDetailScreenWidget extends StatefulWidget {
  ...
  @override
  ModDetailScreen createState() => ModDetailScreen(
      modItem: modItem,
          ...
          child: Padding(
            ...
            child: ListView(
              ...
              children: [
                Container(
                  constraints:
                      const BoxConstraints(maxWidth: 349, maxHeight: 243),
                  child: Image.network(
                    modItem.imageUrl,
                    headers: {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          modItem.fileSize,
                          style: TextStyle(
                              fontSize: 13, color: HexColor.fromHex("#8E8E8E")),
                        ),
                          ...
                          child: Center(
                            child: Row(
                              ...
                              children: [
                                Text(
                                  cached
                                      ? AppLocale.mod_view_downloaded
                                          .getString(context)
                                      : (modItem.isRewarded
                                          ? AppLocale.mod_view_watchads
                                              .getString(context)
                                          : AppLocale.mod_view_install
                                              .getString(context)),
                                  style: TextStyle(
                                      color: cached
                                          ? HexColor.fromHex("#8D8D8D")
                                          : Colors.white,
                                      fontSize: 16,
                                      fontFamily: "Joystix_Bold"),
                                ),
                        ...
                        if (modItem.isPremium)
                          {
                            if (!true)
                            ...
                            else
                              {
                                ...
                                paths =
                                    await FileManager.downloadAndExtractFile(
                                        modItem.downloadURL),
                                setState(() {
                                  cached = true;
                                }),
                                if (paths.length == 1)
                                  {
                                    await FileOpener.openFileWithApp(paths[0],
                                    ...
                                    if (context.mounted)
                                      {
                                        ...
                                        await showModalBottomSheet<void>(
                                          context: context,
                                          backgroundColor: ColorsInfo.GetColor(
                                              ColorType.Second),
                                    ...
                                    if (await AdManager.manager!
                                        .isRewardedAdReady())
                                      {
                                        AdManager.rewardedListener =
                                            RewardedListener(),
                                        await AdManager.manager!.showRewarded(
                                            AdManager.rewardedListener!),
                                        ...
                                        if (AdManager
                                            .rewardedListener!.rewardGranted)
                                          {
                                            installProhibited = false,
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          getMiniMod(
                              modService!.mods[modList][random
                                  .nextInt(modService!.mods[modList].length)],
                              modListScreen,
                              favoriteListScreen,
                              context),
                          getMiniMod(
